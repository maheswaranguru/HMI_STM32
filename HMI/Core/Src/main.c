...
int main(void)
{
  ...
  MX_NVIC_Init();
  /* USER CODE BEGIN 2 */
 // HAL_UART_Transmit( &huart2, "WelCome", 7, 100);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, KYB_CS_Pin|LED_LE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : KYB_CS_Pin LED_LE_Pin */
  GPIO_InitStruct.Pin = KYB_CS_Pin|LED_LE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
